__author__ = 'Yoichi Furugen <n15009@std.it-college.ac.jp>'
...
class Game:
    def __init__(self):
        ...
        self.bg = PhotoImage(file="backdround.gif")
        w = self.bg.width()
        h = self.bg.height()
        for x in range(0, 5):
            for y in range(0, 5):
...
class MovingPlatformSprite(PlatformSprite):
    ...
    def coords(self):
        ...
        self.coordinates.x1 = xy[1]
        self.coordinates.y1 = xy[0]
        self.coordinates.x2 = xy[1] + self.width
        self.coordinates.y2 = xy[0] + self.height
        return self.coordinates
